...
public class DAO implements Interface {
    ...
    public void insert(ModelBuku buku) {
        try {
            String query = "INSERT INTO tempek (judul, penulis, tahun, alur, bahasa, orisinalitas, rating) VALUES (?, ?, ?, ?, ?, ?, ?);";
    ...
    public void update(ModelBuku buku) {
        try {
            String query = "UPDATE tempek SET judul=?, penulis=?, tahun=?, alur=?, bahasa=?, orisinalitas=?, rating=? WHERE id=?;";
    ...
    public void delete(int id) {
        try {
            String query = "DELETE FROM tempek WHERE id=?;";
    ...
    public List<ModelBuku> getAll() {
        ...
        try {
            ...
            String query = "SELECT * FROM tempek;";
